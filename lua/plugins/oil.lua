    ...
    config = function ()
      require("oil").setup({
        ...
        keymaps = {
          ["g?"] = "actions.show_help",
          ["<CR>"] = "actions.select",
          ["<C-d>"] = { "actions.select", opts = { vertical = true }, desc = "Open the entry in a vertical split" },
        ...
        vim.keymap.set('n', '<leader>ov', function ()
          --vim.cmd('vs | vertical resize -70 | wincmd r')
          vim.cmd('vs | wincmd r')
          require('oil').open()
        end, {desc = 'Open Oil vertically split window'}),
